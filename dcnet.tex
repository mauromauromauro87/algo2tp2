...
\serc{sistema}{
	...
	\donde{sistema}{\tupla{
			...
			CompusPorPref : \mbox{diccPref(compu, \tupla{It: ItconjLogP(paquete), ItP: ItconjLog(paquete)}},
			CompusPor\#Envios : \mbox{conjLogP(compu)},
      CaminosMinimos: \mbox{arreglo(arreglo(arreglo(compu)))},
      PaquetePorPrioridad : \mbox{conjLogP(paquete)},
      PaquetesPorID : \mbox{conjLog(paquete)}
	}}
}
