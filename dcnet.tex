...
\serc{sistema}{
	\\
	\donde{sistema}{\tupla{
			Compus : \mbox{arreglo(tupla(IP: String , pP: itConjLogP, pN: itConjLog)}, %esto quedo feo
			CompusPorPref : \mbox{diccPref(compu, \tupla{It: conjLogP(paquete), ItP: conjLog(paquete)}},
